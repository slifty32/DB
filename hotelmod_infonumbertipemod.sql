...
--
-- Table structure for table `infonumbertipemod`
--
...
INSERT INTO `infonumbertipemod` VALUES (1,'одноместный обычный',2000),(2,'одноместный люкс',4000),(3,'двуместный обычный',3500),(4,'двуместный люкс',6000),(5,'2',NULL),(6,'2',NULL),(7,'2',NULL);
/*!40000 ALTER TABLE `infonumbertipemod` ENABLE KEYS */;
UNLOCK TABLES;
